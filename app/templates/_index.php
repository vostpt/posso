...
$troll = false;
if(preg_match('/casa|isolamento|isolado|confinado|confinamento|dormir|descansar|residência|residencia|isolar|tomahock|dgs|sns|sns24|infectad|infeta|infectar|/i', $word)){
    $troll = true;
}
