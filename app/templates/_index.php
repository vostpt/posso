...
$troll = false;
if(preg_match('/casa|isolamento|isolado|confinado|confinamento|dormir|descansar|residência|residencia|isolar|tomahock|dgs|sns|sns24|infectad|infeta|infectar|foder|fornicar|merda|foda|cona|pissa|piça|home|mãe|mae|estudar|governo|ministr|isolated|comer|puta|fuder|cagar|tv|televisão|ouvir|pensar|tweetar|defecar/i', $word)){
    $troll = true;
}
